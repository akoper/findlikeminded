                                ...
                                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                                        <div class="p-6 text-gray-900 dark:text-gray-100">
                                            ...
                                            <p class="mb-5 text-2xl font-bold dark:text-gray-100">Data Deletion</p>

                                            <p class="text-lg lg:text-2xl mb-4">To delete your profile and data, log in to the application,
                                            click on your name in the upper-right-hand corner, click on "Profile" in the dropdown menu,
                                            and then click on the "Delete Account" button at the bottom of the page.</p>

                                            <p class="text-lg lg:text-2xl mb-4">Facebook requires this page and information in order to
                                            be able to create and use its login-with-Facebook feature</p>

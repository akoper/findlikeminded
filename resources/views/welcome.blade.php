                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <!-- ################ Create group button ################ -->
                                <a href="{{ url('groups/create') }}"
                                   class="w-40 py-4 px-6 mb-4 inline-block sm:px-3 sm:w-36 sm:mb-4 lg:mb-0 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg focus:outline-none text-center">
                                    Create Group</a>
                            </div>

                            <div class="flex items-center">
                    <!-- ################ Search groups form/button ################ -->
                                <div class="text-center">
                                    <form action="/groups/search" method="post">
                                        ...
                                        <div class="mb-3 sm:mb-0 pt-0">
                                            ...
                                            <button class="w-40 font-bold py-4 px-6 mt-4 sm:w-36 sm:px-3 lg:mt-0 bg-orange-500 hover:bg-orange-600 text-white rounded-lg">
